...
import { aiClientIntelligenceService, type ClientProfile, type LeadScore, type PredictiveInsights } from '@/services/aiClientIntelligenceService'

interface ClientIntelligenceDashboardProps {
  className?: string
}

export default function ClientIntelligenceDashboard({ className = '' }: ClientIntelligenceDashboardProps) {
  const [clients, setClients] = useState<ClientProfile[]>([])
  const [selectedClient, setSelectedClient] = useState<ClientProfile | null>(null)
  const [leadScore, setLeadScore] = useState<LeadScore | null>(null)
  const [predictions, setPredictions] = useState<PredictiveInsights | null>(null)
  const [loading, setLoading] = useState(false)
  const [activeTab, setActiveTab] = useState<'overview' | 'clients' | 'analytics' | 'automation'>('overview')
  ...
  return (
    <div className={`bg-white rounded-lg shadow-lg ${className}`}>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white p-6 rounded-t-lg">
        <h2 className="text-2xl font-bold mb-2">AI-Powered Client Intelligence</h2>
        <p className="text-blue-100">Hyperlocal lead scoring • Predictive analytics • Automated personalization</p>
      </div>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <div className="text-2xl font-bold text-green-600">
                  {clients.filter(c => c.followUpPriority === 'immediate').length}
                </div>
                <div className="text-sm text-green-800">Immediate Follow-up</div>
              </div>
              <div className="bg-orange-50 p-4 rounded-lg">
                <div className="text-2xl font-bold text-orange-600">
                  {clients.filter(c => c.behavior.engagementScore > 80).length}
                </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="text-lg font-semibold mb-4">Top AI-Scored Clients</h3>
                  ...
                  .map((client) => (
                    <div key={client.id} className="flex items-center justify-between bg-white p-3 rounded-lg">
                      <div>
                        ...
                        <div className="text-sm text-gray-600">{client.location.neighborhood}</div>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className={`px-2 py-1 rounded-full text-xs font-medium ${getPriorityColor(client.followUpPriority)}`}>
                          {client.followUpPriority}
                        </div>
                        <div className="text-lg font-bold text-blue-600">{client.aiScore}</div>
                      </div>
                    </div>
                  ))}
              </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <div className={`inline-block w-3 h-3 rounded-full ${getUrgencyColor(client.followUpPriority)}`}></div>
                          <div className="text-sm text-gray-600 mt-1">{client.followUpPriority}</div>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="text-sm">{selectedClient.firstName} {selectedClient.lastName}</div>
                    ...
                    <div>
                      ...
                      <div className="text-sm">{selectedClient.location.neighborhood}, {selectedClient.location.zipCode}</div>
                    </div>

                    <div>
                      <div className="font-medium text-gray-700">Preferences</div>
                      <div className="text-sm">${selectedClient.preferences.priceRange[0].toLocaleString()} - ${selectedClient.preferences.priceRange[1].toLocaleString()}</div>
                      <div className="text-sm">{selectedClient.preferences.bedrooms.join(', ')} beds, {selectedClient.preferences.bathrooms.join(', ')} baths</div>
                    </div>

                    <div>
                      <div className="font-medium text-gray-700">AI Score</div>
                      <div className="text-2xl font-bold text-blue-600">{selectedClient.aiScore}</div>
                      <div className="text-sm text-gray-600">Next Action: {selectedClient.nextBestAction}</div>
                    </div>
                  </div>
                </div>
              )}
            ...
            {leadScore && (
              <div className="bg-white border rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <div className="text-3xl font-bold text-blue-600 mb-2">{leadScore.overall}/100</div>
                    <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getPriorityColor(leadScore.urgency)}`}>
            ...
            {predictions && (
              <div className="bg-white border rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <div className="text-sm font-medium text-gray-700 mb-2">Next Best Action</div>
                    <div className="text-lg font-semibold text-blue-600">{predictions.nextBestAction}</div>
                  </div>
                  
                  <div>
                    <div className="text-sm font-medium text-gray-700 mb-2">Predicted Timeline</div>
                    <div className="text-lg font-semibold text-green-600">{predictions.predictedTimeline}</div>
                  </div>
                  
                  <div>
                    <div className="text-sm font-medium text-gray-700 mb-2">Confidence</div>
                    <div className="text-lg font-semibold text-purple-600">{predictions.confidence}%</div>
                  </div>
                </div>

                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium text-gray-700 mb-3">Key Factors</h4>
                    <div className="space-y-2">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-700 mb-3">Market Opportunities</h4>
                    <div className="space-y-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Automatic lead prioritization</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Client needs forecasting</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Automated communication</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Dynamic recommendations</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Email, SMS, push notifications</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">ROI and conversion metrics</div>
                    </div>
                  </div>
                </div>
              </div>
