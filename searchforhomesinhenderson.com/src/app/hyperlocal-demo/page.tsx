           ...
           <div className="container mx-auto px-4">
             <div className="max-w-6xl mx-auto text-center">
               ...
               <p className="text-xl mb-8">
                 Discover your perfect home with AI-powered insights • Live MLS data • 
                 Street-level market analysis • Expert guidance
               </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-gray-50 p-8 rounded-lg mb-12">
                ...
                <p className="text-center text-gray-600 mb-6">
                  Browse real-time listings from our MLS database. These are
                  actual properties currently for sale in Henderson.
                </p>
