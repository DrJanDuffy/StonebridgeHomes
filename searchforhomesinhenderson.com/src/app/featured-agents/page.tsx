...
export const metadata: Metadata = {
  title: 'Top Henderson REALTOR | Dr. Jan Duffy - Henderson Real Estate Expert | Henderson Homes',
  description:
  ...
  openGraph: {
    title: 'Top Henderson REALTOR | Dr. Jan Duffy - Henderson Real Estate Expert',
    description: "Henderson's premier real estate expert specializing in Green Valley, Anthem, Stephanie Ranch & Whitney Ranch. Expert HOA navigation, school districts & golf communities.",
  ...
  twitter: {
    ...
    description: "Henderson's premier real estate expert with specialized knowledge of all neighborhoods and communities.",
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto mb-8 text-blue-100">
            Specialized expertise in Henderson's unique neighborhoods, HOA communities, 
            school districts, and golf course living. No one knows Henderson like I do.
          </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    With over 14 years of Henderson real estate expertise, I've helped 
                    hundreds of families find their perfect home in Henderson's most 
                    desirable communities.
                  </p>
                  <p>
                    I'm not just a REALTOR - I'm a Henderson resident, parent, and 
                    community expert who knows every neighborhood, HOA, school district, 
                    and amenity like the back of my hand.
                  </p>
                  <p>
                    My clients choose me because I provide insider knowledge that only 
                    comes from living and working in Henderson for over a decade.
                  </p>
                </div>
                ...
                <div className="mt-8 grid grid-cols-2 gap-6">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600">Henderson Homes Sold</div>
                  </div>
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-3xl font-bold text-green-600">14+</div>
                    <div className="text-sm text-gray-600">Years in Henderson</div>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <div className="text-3xl font-bold text-purple-600">50+</div>
                    <div className="text-sm text-gray-600">Communities Covered</div>
                  </div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">HOA Expert</h4>
                      <p className="text-gray-600 text-sm">Current documents for all 50+ Henderson communities</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">School District Specialist</h4>
                      <p className="text-gray-600 text-sm">Parent of Henderson students with insider knowledge</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Golf Community Expert</h4>
                      <p className="text-gray-600 text-sm">Personal experience with all Henderson golf courses</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Lifestyle Navigator</h4>
                      <p className="text-gray-600 text-sm">Exact drive times and accessibility mapping</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Cost Analysis Pro</h4>
                      <p className="text-gray-600 text-sm">Total monthly cost calculations beyond mortgage</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Relocation Specialist</h4>
                      <p className="text-gray-600 text-sm">200+ families successfully relocated to Henderson</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-gray-600 mb-12">
              Specialized services for Henderson's unique real estate market and community needs
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-600">
                ...
                <ul className="space-y-2 text-gray-700 text-sm">
                  <li>• Green Valley Ranch HOA fee breakdowns ($180-$220/month)</li>
                  <li>• Anthem Country Club membership requirements analysis</li>
                ...
                <p className="mt-3 text-blue-600 font-semibold text-sm">
                  "I maintain current HOA documents for all 50+ Henderson communities"
                </p>
              </div>
              ...
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-600">
                ...
                <ul className="space-y-2 text-gray-700 text-sm">
                  ...
                  <li>• Private school proximity analysis (Faith Lutheran, etc.)</li>
                  <li>• Magnet program application assistance</li>
                </ul>
                <p className="mt-3 text-green-600 font-semibold text-sm">
                  "Parent of Henderson students - I know which schools have space"
                </p>
              </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-gray-600 mb-12">
              Deep knowledge of every Henderson community and what makes each unique
            </p>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-lg">
                <h3 className="text-2xl font-bold mb-4 text-green-800">Green Valley</h3>
                <p className="text-gray-600 mb-4">
                  Henderson's premier master-planned community with luxury homes, 
                  championship golf, and upscale shopping at The District.
                </p>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-green-600">Green Valley HS</span>
                  </div>
                </div>
                <p className="mt-4 text-green-600 font-semibold text-sm">
                  "I've sold 45+ homes in Green Valley - I know every street and community"
                </p>
              </div>

              <div className="bg-white p-8 rounded-xl shadow-lg">
                <h3 className="text-2xl font-bold mb-4 text-blue-800">Anthem</h3>
                <p className="text-gray-600 mb-4">
                  Hillside community with stunning views, resort-style amenities, 
                  and access to Anthem Country Club golf course.
                </p>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Price Range:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Schools:</span>
                    <span className="font-semibold text-blue-600">Liberty HS</span>
                  </div>
                </div>
                <p className="mt-4 text-blue-600 font-semibold text-sm">
                  "Anthem resident for 8 years - I know the community inside and out"
                </p>
              </div>

              <div className="bg-white p-8 rounded-xl shadow-lg">
                <h3 className="text-2xl font-bold mb-4 text-purple-800">Stephanie Ranch</h3>
                <p className="text-gray-600 mb-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Schools:</span>
                    <span className="font-semibold text-purple-600">Coronado HS</span>
                  </div>
                </div>
                <p className="mt-4 text-purple-600 font-semibold text-sm">
                  "Stephanie Ranch expert - I know every family-friendly amenity"
                </p>
              </div>

              <div className="bg-white p-8 rounded-xl shadow-lg">
                <h3 className="text-2xl font-bold mb-4 text-orange-800">Whitney Ranch</h3>
                <p className="text-gray-600 mb-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Schools:</span>
                    <span className="font-semibold text-orange-600">Whitney HS</span>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-blue-50 p-6 rounded-xl">
                ...
                <p className="text-gray-700 mb-4">
                  "Dr. Jan Duffy's knowledge of Henderson HOA communities is unmatched. 
                  She saved us thousands by finding a home with reasonable HOA fees 
                  in Green Valley."
                </p>
              ...
              <div className="bg-green-50 p-6 rounded-xl">
                ...
                <p className="text-gray-700 mb-4">
                  "As parents moving to Henderson, Jan's school district expertise 
                  was invaluable. She knew exactly which neighborhoods had space 
                  in the best schools."
                </p>
                <div className="text-sm">
              ...
              <div className="bg-purple-50 p-6 rounded-xl">
                ...
                <p className="text-gray-700 mb-4">
                  "Jan's golf community knowledge helped us find the perfect home 
                  near Anthem Country Club. She knew all the membership requirements 
                  and transfer processes."
                </p>
                <div className="text-sm">
                  <div className="font-semibold text-gray-900">Robert & Maria Garcia</div>
                  <div className="text-gray-600">Anthem Country Club Members</div>
                </div>
              </div>
            </div>
          </div>
