...
export const metadata: Metadata = {
  ...
  description: 'Get an instant home value estimate for your Henderson, Nevada property. Free online valuation tool with local market data and recent comparable sales. Expert property appraisal.',
  keywords: 'Henderson home value, home worth Henderson, property value Nevada, home valuation Henderson, real estate appraisal Henderson, property assessment Henderson NV',
  openGraph: {
